...
class Bot: # The main bot class
  ...
  def composeResponse(self):
    if self.queryType == qTypes.WIKI:
      ...
      if queryGotten == None:
        print(helpers.naturalSpeechComposer(phrases.unknownDictionaryTemplates, self.query))
      else:
        print(helpers.naturalSpeechComposer(phrases.wikiTemplates, queryGotten))
